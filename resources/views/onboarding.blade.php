...
<div>
    ...
    <div class="container">
        ...
        <form action="{{ route('onboarding.store') }}" method="POST">
            ...
            <input type="text" name="port" placeholder="Enter MQTT Port - usually 1883" class="border p-2 w-full mb-4" required>
            <input type="text" name="mqtt_auth_username" placeholder="Enter MQTT Username" class="border p-2 w-full mb-4" required>
            <input type="password" name="mqtt_auth_password" placeholder="Enter MQTT Password" class="border p-2 w-full mb-4" required>
