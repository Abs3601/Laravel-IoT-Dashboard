        <div class="card bg-card-light dark:bg-card-dark rounded-3xl shadow-md overflow-hidden h-full hover:scale-[1.02] hover:brightness-110 transition-all duration-300 ease-in-out relative isolate border border-transparent dark:border-gray-700">
