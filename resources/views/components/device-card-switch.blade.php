            ...
            <div class="card-body p-6 flex flex-col h-full pointer-events-none relative z-10">
                <div class="card-container flex items-start">
                    <div class="left-side flex-1">
                        <div class="flex items-start justify-between pointer-events-auto w-full">
                            <h1 class="text-2xl font-semibold text-white">{{ $friendlyName }}</h1>
                            <button wire:click.prevent.stop="togglePin({{ $device->id }})" class="btn btn-ghost btn-circle btn-sm text-yellow-500 hover:text-yellow-400 hover:bg-transparent relative z-20">
                                @if($device->is_pinned ?? false)
                        ...
                        <div class="flex items-center gap-4 mt-4 relative z-10 pointer-events-auto">
                        ...
                        <p class="text-sm font-light text-gray-400 mt-2 pointer-events-auto">
